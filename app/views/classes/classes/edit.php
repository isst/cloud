...
<div class="pageContent">
	<form method="post" action="classes/classes/edit.html?id=<?php echo $class->id; ?>" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
