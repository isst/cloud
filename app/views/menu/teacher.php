...
<?php if ($user->is_class_adviser || $user->is_major_adviser || $user->is_supervisor): ?>
...
<div class="accordionContent">
	<ul class="tree treeFolder">
		<li><a href="users/teacher/edit.html?id=<?php echo $user->id; ?>" rel="users/teacher/edit.html?id=<?php echo $user->id; ?>" target="dialog" width="400" height="300" rel="student_edit" mask="true">修改资料</a></li>
	</ul>
</div>