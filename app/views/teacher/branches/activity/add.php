<div class="pageContent">
    <form method="post" action="branches/activity/add.html?class_id=<?php echo $class_id; ?>" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
			...
			<div class="tabs">
				...
				<div class="tabsContent">
					...
					<div layoutH="110" style="display:block; overflow:auto; border:solid 1px #CCC; line-height:21px; background:#fff; margin: 0 auto; padding: 10px;">
						...
						<p>
							<label>实到人数：</label>
							<input type="text" value="" name="people_actual" class="textInput">
						</p>
						<p>
							<label>活动预算：</label>
					...
					<div layoutH="110" style="display:block; overflow:auto; border:solid 1px #CCC; line-height:21px; background:#fff; margin: 0 auto; padding: 10px;">
						...
						<p>
							...
							<textarea class="editor" tools="mini" name="money_usage" rows="12" style="width: 645px ;height: 360px;"></textarea>
						</p>
					</div>
					...
					<div layoutH="110" style="display:block; overflow:auto; border:solid 1px #CCC; line-height:21px; background:#fff; margin: 0 auto; padding: 10px;">
						...
						<p>
							<label>活动总结：</label>
							<textarea class="editor" tools="mini" name="summary" rows="12" style="width: 645px ;height: 360px;"></textarea>
						</p>
					</div>
					...
					<div layoutH="110" style="display:block; overflow:auto; border:solid 1px #CCC; line-height:21px; background:#fff; margin: 0 auto; padding: 10px;">
						...
						<p>
							...
							<textarea class="editor" tools="mini" name="detail" rows="12" style="width: 645px ;height: 360px;"></textarea>
						</p>
					</div>
