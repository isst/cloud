...
<div class="pageContent" style="padding:5px">
	<div class="tabs">
		<div class="tabsHeader">
			<div class="tabsHeaderContent">
				<ul>
					...
					<li><a href="branches/payment.html?class_id=<?php echo $branch->id; ?>" class="j-ajax"><span>党费交付</span></a></li>
				</ul>
			</div>
		</div>
		<div class="tabsContent">
				...
				<div class="pageContent">
					<div>
						<div layoutH="72" style="display:block; overflow:auto; border:solid 1px #CCC; line-height:21px; background:#fff; margin: 0 auto; padding: 10px;">
							...
							<div style="margin:15px;">所在班级：<?php echo $branch->class_name; ?></div>
			...
			<div id="branch_payment">党费交付</div>
			<div id="branch_info">信息发布推送</div>
		</div>
