...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="icon" href="branches/penalty.html?class_id=<?php echo $branch->id; ?>" target="ajax" rel="reward_penalty_box"><span>刷新</span></a></li>
        </ul>
    </div>
            ...
            <tbody>
				<?php foreach ($penalties as $penalty): ?>
					<tr target="penalty" rel="<?php echo $penalty->penalty_id; ?>">
						...
						<td>
							<a href="branches/penalty/view.html?id=<?php echo $penalty->penalty_id; ?>" target="dialog" width="645" height="400" mask="true"><?php echo $penalty->title; ?></a>
						</td>
