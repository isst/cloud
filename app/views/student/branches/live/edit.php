...
<div class="pageContent">
	<form method="post" action="branches/live/edit.html?id=<?php echo $live->id; ?>" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
            ...
            <p>
                <label>时间：</label>
                <input type="text" value="<?php echo $live->time; ?>" name="time" class="date" readonly="true"/>
                <a class="inputDateButton" href="javascript:;">选择</a>
            </p>
			<p>
				<label>内容：</label>
				<textarea class="editor" tools="mini" name="content" rows="10" cols="80" style="width: 600px;"><?php echo $live->content; ?></textarea>
			</p>
		</div>
		<div class="formBar">
			<ul>
