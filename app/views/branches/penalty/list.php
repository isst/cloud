            ...
            <tbody>
                <?php foreach ($penalties as $penalty): ?>
                    <tr target="penalty" rel="<?php echo $penalty->penalty_id; ?>">
                        ...
                        <td>
                            <a href="users/student/view.html?id=<?php echo $penalty->student_id; ?>" rel="users/student/view.html?id=<?php echo $penalty->student_id; ?>" target="navTab"><?php echo $penalty->student_name; ?></a>
                        </td>
                        <td>
