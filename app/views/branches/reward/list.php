            ...
            <tbody>
                <?php foreach ($rewards as $reward): ?>
                    <tr target="reward" rel="<?php echo $reward->reward_id; ?>">
                        ...
                        <td>
                            <a href="users/student/view.html?id=<?php echo $reward->student_id; ?>" rel="users/student/view.html?id=<?php echo $reward->student_id; ?>" target="navTab"><?php echo $reward->student_name; ?></a>
                        </td>
                        <td>
