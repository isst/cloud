		...
		<div class="tabsHeader">
			<div class="tabsHeaderContent">
				<ul>
					...
					<?php if ('student' == $user_type && 1 == $user->branch_title): ?>
						<li><a href="branches/excellent_full/student_list.html?class_id=<?php echo $branch->id; ?>" class="j-ajax"><span>推优与转正</span></a></li>
					<?php endif; ?>
				</ul>
			</div>
		</div>
				...
				<div class="pageContent">
					<div>
						<div layoutH="72" style="display:block; overflow:auto; border:solid 1px #CCC; line-height:21px; background:#fff; margin: 0 auto; padding: 10px;">
							<h2 class="contentTitle"><?php echo $branch->name; ?>党支部</h2>
							<div style="margin:15px;">班级：<?php echo $branch->name; ?></div>
							<div style="margin:15px;">指导老师：<?php echo $branch->branch_instructor_name; ?></div>
						...
						<div style="position: absolute; right: 20px; bottom: 10px;">
							<a class="button" target="dialog" mask="true" rel="class_edit" href="classes/classes/edit.html?id=<?php echo $branch->id; ?>"><span>编辑</span></a>
						</div>
					</div>
				</div>
			</div>
