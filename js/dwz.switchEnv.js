		...
		return this.each(function(){
			...
			$box.find("li>a").click(function(){
				...
				$.post($a.attr("href"), {}, function(html){
					...
					// 扩展 DWZ 使其支持点击导航菜单时默认打开某几个选项卡
					var defaultOpenTabs = $("#sidebar .tree").find("a.default");
					defaultOpenTabs.each(function(){
						navTab.openTab($(this).attr("rel") || "_blank", $(this).attr("href"),{
